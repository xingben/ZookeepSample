...
public class EntryPoint implements Daemon {
	private LeaderLatchService service = null;
	...
	public void init(DaemonContext arg0) throws DaemonInitException, Exception {
		Injector injector = Guice.createInjector(new LeaderLatchModule());
		service = injector.getInstance(LeaderLatchService.class);
		service.initialize();
	}
